...
from background_tasks.deletespot import check_and_delete_spot
...
def delete_spot(payload: AllID, db: DbSession, user_id: MerchantId):
    ...
    try:
        ...
        if not lot:
            raise api_error(404, "Lot not found")
        ...
        raise_if_error(validate_spot_deletable(spot))
